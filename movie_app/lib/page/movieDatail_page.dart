...
import 'package:movieapp/model/castCrew_model.dart';
import 'package:movieapp/model/movieCredit_model.dart';
import 'dart:convert';
import 'package:movieapp/model/movie_model.dart';
import 'package:movieapp/model/movielDetail_model.dart';
...
class _MovieDetails extends State<MovieDetail> {
  ...
  Future<CastCrew> _fetchMovieCredits() async {
    setState(() {
      isLoading = true;
    });
